...
class ApiApplicationTest {
    ...
    @MockBean
    MockEmployeeClient client; // stub external calls
    ...
    void getAllEmployees_returnsList() {
        Mockito.when(client.getAll()).thenReturn(List.of(
        ...
        ResponseEntity<Employee[]> resp = http.getForEntity(url("/employees"), Employee[].class);
    ...
    void getEmployeesByNameSearch_filtersCaseInsensitive() {
        ...
        ResponseEntity<Employee[]> resp =
                http.getForEntity(url("/employees/search/ti"), Employee[].class);
    ...
    void getEmployeeById_found_and_notFound() {
        ...
        ResponseEntity<Employee> ok =
                http.getForEntity(url("/employees/abc"), Employee.class);
        assertThat(ok.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(ok.getBody().getId()).isEqualTo("abc");

        // not found
        ResponseEntity<String> nf =
                http.getForEntity(url("/employees/zzz"), String.class);
    ...
    void getHighestSalaryOfEmployees_returnsMax() {
        ...
        ResponseEntity<Integer> resp =
                http.getForEntity(url("/employees/highestSalary"), Integer.class);
    ...
    void getTopTenHighestEarningEmployeeNames_sortedAndLimited() {
        ...
        ResponseEntity<String[]> resp =
                http.getForEntity(url("/employees/topTenHighestEarningEmployeeNames"), String[].class);
    ...
    void createEmployee_validBody_returnsCreated() {
        ...
        ResponseEntity<Employee> resp =
                http.postForEntity(url("/employees"), input, Employee.class);
    ...
    void createEmployee_invalidBody_returns400() {
        ...
        ResponseEntity<String> resp =
                http.postForEntity(url("/employees"), req, String.class);
    ...
    void deleteEmployeeById_happyPath_resolvesNameThenDeletes() {
        ...
        ResponseEntity<String> resp =
                http.exchange(url("/employees/id-123"), HttpMethod.DELETE, null, String.class);
    ...
    void deleteEmployeeById_notFound_returns404() {
        ...
        ResponseEntity<String> resp =
                http.exchange(url("/employees/nope"), HttpMethod.DELETE, null, String.class);
    ...
    void deleteEmployeeById_deleteFails_returns409() {
        ...
        ResponseEntity<String> resp =
                http.exchange(url("/employees/x"), HttpMethod.DELETE, null, String.class);
