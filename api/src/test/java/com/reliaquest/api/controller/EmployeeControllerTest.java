...
public class EmployeeControllerTest {
    ...
    void search_ok() throws Exception {
        Mockito.when(service.searchByName("ti")).thenReturn(List.of(
                new Employee("1","Tiger Nixon",320800,61,"Vice Chair","t@x.com")
        ));

        mvc.perform(get("/employees/search/ti"))
                .andExpect(status().isOk())
    ...
    void getById_notFound() throws Exception {
        ...
        mvc.perform(get("/employees/nope"))
                .andExpect(status().isNotFound());
    }

    @Test
    void highestSalary_ok() throws Exception {
        Mockito.when(service.highestSalary()).thenReturn(320800);
        mvc.perform(get("/employees/highestSalary"))
                .andExpect(status().isOk())
    ...
    void top10_ok() throws Exception {
        ...
        mvc.perform(get("/employees/topTenHighestEarningEmployeeNames"))
                .andExpect(status().isOk())
    ...
    void delete_ok() throws Exception {
        Mockito.when(service.deleteByIdReturnName("5255")).thenReturn("Bill Bob");
        mvc.perform(delete("/employees/5255"))
                .andExpect(status().isOk())
